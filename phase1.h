...
extern void  startProcesses(void);    // never returns!
    ...
    // TODO: gcc supports   __attribute__((noreturn))   https://stackoverflow.com/questions/25408795/tell-gcc-that-a-function-call-will-not-return
    //       What happens if I have this turned on while compiling on Mac?
...
extern void mmu_switch(int new_pid);
