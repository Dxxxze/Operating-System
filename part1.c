 ...
 */
int fork(char *name, int(*func)(char *), char *arg, int stacksize, int priority) {
	// check kernel mode and disable interrupt
	checkKernelMode("fork");
